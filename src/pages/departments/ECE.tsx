          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">Excel in professional career and/or higher education by acquiring knowledge in mathematics, science and electronics & communication engineering principles.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                <h4 className="text-lg font-semibold text-blue-800">PEO 2</h4>
                <p className="text-gray-700">Analyze real-life problems and design socially responsible and environmentally sustainable electronics-based solutions.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">Apply knowledge of mathematics, science, engineering fundamentals, and electronics & communication engineering principles to solve complex engineering problems.</p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">Apply the knowledge of electronics devices and circuits for the design of systems in the field of communications.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                <h4 className="text-lg font-semibold text-green-800">PSO 2</h4>
                <p className="text-gray-700">Apply engineering techniques to design, analyze and implement signal processing systems.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                <h4 className="text-lg font-semibold text-green-800">PSO 3</h4>
                <p className="text-gray-700">Develop applications using embedded systems and VLSI technology for real-world problems.</p>
              </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="animate-fade-in">
            ...
            <p className="text-gray-700 mb-4">
              The course outcomes for all courses offered by the Electronics and Communication Engineering department are designed to align with program outcomes and educational objectives.
            </p>
            <div className="mb-4">
              <a
                href="https://srivasaviengg.ac.in/uploads/ece/COs.pdf"
                target="_blank"
                rel="noopener noreferrer"
  ...
  const renderContent = () => {
    ...
    switch (activeContent) {
      ...
      case 'Physical Facilities':
        ...
        const facilityTypes = Array.from(new Set(physicalfacilities.map((f: any) => f.type || f.category || 'Other')));
        const groupedFacilities = facilityTypes.map(type => ({
          category: type,
          items: physicalfacilities.filter((f: any) => (f.type || f.category || 'Other') === type)
        }));
              ...
              <div className="space-y-6">
                {groupedFacilities.map((group, index) => (
                  <details key={group.category} open={index === 0} className="cst-dropdown">
                    <summary>{group.category.replace(/_/g, ' ').replace(/\b\w/g, (l: string) => l.toUpperCase())}</summary>
                    <div className="cst-dropdown-content">
                      <ul className="list-disc pl-6 my-2 space-y-2">
              ...
              <details className="cst-dropdown">
                ...
                <div className="cst-dropdown-content">
                  <div className="space-y-6">
                    ...
                    {technicalAssociationActivities.filter(item => item.type === 'gallery_2k19').length > 0 && (
                      <div>
                        <h4 className="text-xl font-bold text-[#B22222] mb-4">TECKVEDA-2K19</h4>
                    ...
                    {technicalAssociationActivities.filter(item => item.type === 'gallery_2k18').length > 0 && (
                      <div>
                        <h4 className="text-xl font-bold text-[#B22222] mb-4">TECKVEDA-2K18</h4>
                        <div className="grid grid-cols-2 gap-4">
                          {technicalAssociationActivities
                    ...
                    {technicalAssociationActivities.filter(item => item.type === 'gallery_2k19' || item.type === 'gallery_2k18').length === 0 && (
                ...
                <div className="cst-dropdown-content">
                  {placements.length > 0 ? (
                    placements.map((placement, idx) => (
                      <div key={placement.year} className="mb-4">
                  ...
                  <tbody>
                    {mous.map((mou: any, index: number) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="py-3 px-4 border-b">{index + 1}</td>
                        <td className="py-3 px-4 border-b">{mou.organisation || mou.organization_name}</td>
                          ...
                          <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            <div className="flex-1">
                              <span className="font-medium text-gray-900">
                                {minute.meeting_title} - {minute.meeting_number}
                              </span>
                              <span className="text-gray-600 ml-2">
                                ({formatDate(minute.meeting_date)}) [{minute.academic_year}]
                              </span>
                            </div>
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="px-4 py-2 bg-[#B22222] text-white rounded hover:bg-[#A01E1E] transition-colors text-sm font-medium"
                            >
                              View Document
                            </a>
                          </div>
