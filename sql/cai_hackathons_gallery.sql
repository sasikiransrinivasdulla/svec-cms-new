-- Create table for CSE-AI Hackathons Gallery
-- This table stores gallery images separately from the main hackathons table
-- to avoid the VARCHAR length limitation for multiple image URLs
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Gallery images for hackathon events - one image per row';
